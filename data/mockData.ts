...
import { Campaign, CampaignStatus, Transaction } from '../types';
...
export const MOCK_CAMPAIGNS: Campaign[] = [
  ...
  },
  {
    ...
    targetAmount: 15000,
    raisedAmount: 15000,
    status: CampaignStatus.LOCKED_FUNDED,
    category: 'Education',
  ...
  },
  {
    ...
    targetAmount: 8000,
    raisedAmount: 8000,
    status: CampaignStatus.VERIFICATION_PENDING,
  ...
  },
  {
    ...
    targetAmount: 6500,
    raisedAmount: 6500,
    status: CampaignStatus.DISBURSED,
    category: 'Healthcare',
...
export const MOCK_TRANSACTIONS: Transaction[] = [
  // Recent
  { hash: 'tx_a1...bc', campaignId: '15', from: 'addr_donor_x', to: 'sc_pool', amount: 500, timestamp: '2023-10-30 14:20', type: 'DONATION', blockHeight: 9234500 },
  { hash: 'tx_a2...de', campaignId: '15', from: 'addr_donor_y', to: 'sc_pool', amount: 1500, timestamp: '2023-10-30 12:15', type: 'DONATION', blockHeight: 9234480 },
  { hash: 'tx_b3...fg', campaignId: '13', from: 'addr_donor_z', to: 'sc_pool', amount: 1000, timestamp: '2023-10-29 09:30', type: 'DONATION', blockHeight: 9234300 },
  { hash: 'tx_c4...hi', campaignId: '11', from: 'addr_donor_a', to: 'sc_pool', amount: 10000, timestamp: '2023-10-28 16:45', type: 'DONATION', blockHeight: 9234200 },
  { hash: 'tx_c5...jk', campaignId: '11', from: 'addr_donor_b', to: 'sc_pool', amount: 8500, timestamp: '2023-10-28 11:10', type: 'DONATION', blockHeight: 9234150 },
  
  // Mid
  { hash: 'tx_d6...lm', campaignId: '8', from: 'addr_donor_c', to: 'sc_pool', amount: 1200, timestamp: '2023-10-25 10:00', type: 'DONATION', blockHeight: 9234101 },
  { hash: 'tx_e7...no', campaignId: '2', from: 'addr_donor_d', to: 'sc_pool', amount: 5000, timestamp: '2023-10-24 14:30', type: 'DONATION', blockHeight: 9234050 },
  { hash: 'tx_e8...pq', campaignId: '2', from: 'addr_donor_e', to: 'sc_pool', amount: 10000, timestamp: '2023-10-24 13:00', type: 'DONATION', blockHeight: 9234040 },
  { hash: 'tx_f9...rs', campaignId: '6', from: 'addr_donor_f', to: 'sc_pool', amount: 2800, timestamp: '2023-10-22 15:20', type: 'DONATION', blockHeight: 9233900 },
  
  // Actions
  { hash: 'tx_g0...tu', campaignId: '3', from: 'addr_ngo', to: 'sc_contract', amount: 0, timestamp: '2023-10-26 09:15', type: 'PROOF_SUBMISSION', blockHeight: 9234220 },
  { hash: 'tx_h1...vw', campaignId: '9', from: 'addr_ngo_cross', to: 'sc_contract', amount: 0, timestamp: '2023-10-20 08:45', type: 'PROOF_SUBMISSION', blockHeight: 9233500 },
  { hash: 'tx_i2...xy', campaignId: '14', from: 'addr_ngo_benue', to: 'sc_contract', amount: 0, timestamp: '2023-10-18 10:30', type: 'PROOF_SUBMISSION', blockHeight: 9233200 },
  
  // Disbursements & Completion
  { hash: 'tx_j3...zA', campaignId: '4', from: 'sc_contract', to: 'addr_ngo_green', amount: 6500, timestamp: '2023-10-20 11:00', type: 'DISBURSEMENT', blockHeight: 9233000 },
  { hash: 'tx_k4...BC', campaignId: '4', from: 'sc_policy', to: 'addr_ngo_green', amount: 0, timestamp: '2023-10-20 11:05', type: 'NFT_MINT', blockHeight: 9233005 },
  { hash: 'tx_l5...DE', campaignId: '12', from: 'sc_contract', to: 'addr_ngo_anambra', amount: 7000, timestamp: '2023-10-15 14:00', type: 'DISBURSEMENT', blockHeight: 9232000 },
  { hash: 'tx_m6...FG', campaignId: '12', from: 'sc_policy', to: 'addr_ngo_anambra', amount: 0, timestamp: '2023-10-15 14:05', type: 'NFT_MINT', blockHeight: 9232005 },
  
  // Older
  { hash: 'tx_n7...HI', campaignId: '10', from: 'addr_donor_old', to: 'sc_pool', amount: 2500, timestamp: '2023-07-12 09:00', type: 'DONATION', blockHeight: 9220000 },
  { hash: 'tx_o8...JK', campaignId: '10', from: 'sc_contract', to: 'addr_ngo_hope', amount: 2500, timestamp: '2023-08-01 10:00', type: 'DISBURSEMENT', blockHeight: 9225000 },
  { hash: 'tx_p9...LM', campaignId: '10', from: 'addr_ben...old', to: 'sc_contract', amount: 0, timestamp: '2023-08-05 11:30', type: 'COMPLETED', blockHeight: 9225500 },
  
  // More filler transactions
  { hash: 'tx_q0...NO', campaignId: '7', from: 'addr_donor_g', to: 'sc_pool', amount: 5000, timestamp: '2023-09-16 10:00', type: 'DONATION', blockHeight: 9230000 },
  { hash: 'tx_r1...PQ', campaignId: '7', from: 'addr_donor_h', to: 'sc_pool', amount: 5000, timestamp: '2023-09-17 11:00', type: 'DONATION', blockHeight: 9230100 },
  { hash: 'tx_s2...RS', campaignId: '5', from: 'addr_donor_i', to: 'sc_pool', amount: 2000, timestamp: '2023-10-21 09:00', type: 'DONATION', blockHeight: 9233800 },
  { hash: 'tx_t3...TU', campaignId: '5', from: 'addr_donor_j', to: 'sc_pool', amount: 2500, timestamp: '2023-10-21 14:00', type: 'DONATION', blockHeight: 9233850 },
  { hash: 'tx_u4...VW', campaignId: '1', from: 'addr_donor_k', to: 'sc_pool', amount: 1000, timestamp: '2023-10-16 10:00', type: 'DONATION', blockHeight: 9232500 },
  { hash: 'tx_v5...XY', campaignId: '1', from: 'addr_donor_l', to: 'sc_pool', amount: 1700, timestamp: '2023-10-17 11:00', type: 'DONATION', blockHeight: 9232600 }
];
